...
- PDF フラット化機能を追加し、注釈やフォーム widget を編集不能な通常 PDF として書き出せるようにしました
- フォーム付き PDF と broken appearance 系 PDF を含む flatten 回帰テストを追加し、`fitz.Document.bake()` 周辺の安定性を固定しました
- flatten の presenter / view テストと利用者向け文書、設計書、HTML 文書を更新しました
