...
26. Update documents following new features and test coverage, ensuring that the rationale for design decisions and user guidance around Ghostscript usage are clearly communicated. This upgrade is versioned as v1.2.0 in the release notes.
27. Update the version info in the .toml, .spec, .iss, and .ps1 files to 1.2.0 for the release that includes this feature.
